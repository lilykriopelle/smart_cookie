...
ActiveRecord::Schema.define(version: 20150517175657) do
  ...
  add_index "votes", ["voteable_id", "voter_id"], name: "index_votes_on_voteable_id_and_voter_id", unique: true, using: :btree
